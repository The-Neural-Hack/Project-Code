...
intent_response_dict = {
    "intro": ["This is a FemHACKS bot. One stop to all your FAQ menstrupedia related queries"],
    "greet":["Hey","Hello","Hi"],
...
gstinfo_response_dict = {
    ...
    "faq_link":'You can check all the answers here <a href="http://questions.menstrupedia.com/questions/</a>'
}
